...
public class My_Coupon extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View wizard = getLayoutInflater().inflate(R.layout.my_coupon, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.help:
                ...
                intent.setClass(My_Coupon.this,Customer_Service.class);
