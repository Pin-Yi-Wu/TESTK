...
public class My_Funds extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View wizard = getLayoutInflater().inflate(R.layout.my_funds, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.help:
                ...
                intent.setClass(My_Funds.this,Customer_Service.class);
