...
public class My_Event extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View wizard = getLayoutInflater().inflate(R.layout.my_event, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.help:
                ...
                intent.setClass(My_Event.this,Customer_Service.class);
