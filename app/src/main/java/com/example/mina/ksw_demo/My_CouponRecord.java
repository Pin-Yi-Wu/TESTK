...
public class My_CouponRecord extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View wizard = getLayoutInflater().inflate(R.layout.my_couponrecord, null);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.help:
                ...
                intent.setClass(My_CouponRecord.this,Customer_Service.class);
